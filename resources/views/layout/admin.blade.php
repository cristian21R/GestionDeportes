...
<head>
    ...
    <link href="{{ asset('plantilla/admin/vendor/fontawesome-free/css/all.min.css') }}" rel="stylesheet">
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="index.html">
                ...
                <div class="sidebar-brand-text mx-3">Gestion <sup>Deportiva</sup></div>
            </a>
           ...
           <li class="nav-item">
                <a class="nav-link collapsed" href="{{route('disciplina.index')}}" >
                    <i class="fas fa-fw fa-cog"></i>
                        ...
                        <li class="nav-item dropdown no-arrow">
                            <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button"
                                ...
                                <img class="img-profile rounded-circle"
                                    src="{{ asset('plantilla/admin/img/undraw_profile.svg') }}">                                
                            </a>
            ...
            <footer class="sticky-footer bg-white">
                <div class="container my-auto">
                    <div class="copyright text-center my-auto">
                        <span>Copyright &copy; Desarrollado por: Cristian Roblero</span>
                    </div>
                </div>
            </footer>
            <!-- End of Footer -->
...
<!-- Page level plugins -->
<script src="{{ asset('plantilla/admin/vendor/chart.js/Chart.min.js') }}"></script>
